...
/**
 The representation of one private or public v3 anyone service authentication key.
 */
...
/**
 The full  anyone service URL.
 */
@property (nonatomic, readonly, nullable) NSURL *anyoneAddress;
...
/**
 ...
 @param url A URL containing the v3 anyone service domain for which this key is.
 */
